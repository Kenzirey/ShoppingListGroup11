...
class _MealRecipeScreenState extends ConsumerState<MealRecipeScreen> {
  ...
  final List<String> weekDays = List.generate(
    7,
    (i) => DateFormat('EEEE')
        .format(DateTime(2025, 1, 4).add(Duration(days: i))),
  );
                    ...
                    if (isSaved) {
                      ...
                      if (savedRecipe != null) {
                        ...
                        ScaffoldMessenger.of(context)
                          ...
                          ..showSnackBar(
                            CustomSnackbar.buildSnackBar(
                              title: 'Removed',
                              message: '${currentRecipe.name} removed from saved recipes.',
                              innerPadding: const EdgeInsets.symmetric(horizontal: 16),
                            ),
                          );
                      }
                      ...
                      ScaffoldMessenger.of(context)
                        ...
                        ..showSnackBar(
                          CustomSnackbar.buildSnackBar(
                              title: 'Saved',
                              message: '${currentRecipe.name} saved to your recipes.',
                              innerPadding: const EdgeInsets.symmetric(horizontal: 16),
                            ),
                        );
                    }
